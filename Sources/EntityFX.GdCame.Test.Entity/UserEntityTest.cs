...
namespace EntityFX.Gdcame.Test.Entity
{
    ...
    public class UserEntityTest
    {
        ...
        private static readonly string ConnString =
            "Data Source=amukintern.testrussia.local;Initial Catalog=IclServicesWcfTestLab;Persist Security Info=True;User ID=sa;Password=P@ssword;MultipleActiveResultSets=True;App=EntityFramework";
