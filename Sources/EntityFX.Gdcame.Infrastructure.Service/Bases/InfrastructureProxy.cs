...
namespace EntityFX.Gdcame.Infrastructure.Service.Bases
{
        ...
        where TBinding : Binding
    {
        ...
        TServiceContract ApplyContextScope<TContextType>(Action<TContextType> applyContextAction,
            TContextType contextData);
        ...
        where TBinding : Binding
    {
        ...
        public virtual TServiceContract ApplyContextScope<TContextType>(Action<TContextType> applyContextAction,
            TContextType contextData)
        {
