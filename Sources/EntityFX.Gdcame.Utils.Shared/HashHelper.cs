...
using EntityFX.Gdcame.Utils.Shared.Rendezvous_Hashing;
...
namespace EntityFX.Gdcame.Utils.Shared
{
    public class HashHelper : IHashHelper
    {
        ...
        public int GetModulo(string userId, int modulo)
        {
            Int64 value = 0;
        ...
        public int GetServerNumberByRendezvousHashing(string userId, string[] servers)
        {
